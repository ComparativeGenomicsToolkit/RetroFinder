...
${BINDIR}/pslCDnaGenomeMatch all_mrna_double.sort.psl S1.len mrnaNoversion.2bit /hive/data/genomes/$DB/nib all_mrna_double.filter.psl -score=all_mrna_double.score -bedOut=all_mrna_double.bed  -verbose=3 -minDiff=4 -notAlignPenalty=3 > all.log 
