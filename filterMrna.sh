...
pslCDnaGenomeMatch all_mrna_double.sort.psl S1.len all_mrna.2bit /cluster/data/$DB/nib all_mrna_double.filter.psl -score=all_mrna_double.score -bedOut=all_mrna_double.bed  -verbose=3 -minDiff=5 > all.log 
